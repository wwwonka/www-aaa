...
/**
 * Engine handles a loader's {@link IResourceLoader.parse} may need. Optional field by field —
 * today only {@link IResourceLoader} implementations for mesh/texture formats need `scene`.
 */
